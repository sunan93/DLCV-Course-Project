...
class _VictimBase:
    ...
    def __init__(self, args, setup=dict(device=torch.device('cpu'), dtype=torch.float), model_to_load=""):
        ...
        self.initialize(model_to_load=model_to_load)
    ...
    def _initialize_model(self, model_name):
        ...
        optimizer.param_groups[0]['lr'] = 0.001 #remove when clean training model
